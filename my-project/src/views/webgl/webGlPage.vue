...
import animationTexture from './7AnimationTexture/index.vue'
export default {
  components: {drawPolygon, colorPolygon, animationPolygon, threeDObjects, threeDObjectsTexture, threedDLighting, animationTexture}
}
</script>
